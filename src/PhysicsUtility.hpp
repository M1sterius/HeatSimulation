...
const float THERMAL_EXPANSION_COEFFICIENT = 0.047f; // determines how much upward force the heat will produce
// ---------------------------------------------

bool Collide(Particle* p1, Particle* p2);

// Conducts heat between two particles on collision over time
